...
<div class="bx-catalog-element bx-<?=$arParams['TEMPLATE_THEME']?>" id="<?=$itemIds['ID']?>"
	...
	<div class="container-fluid">
		...
		<? 
		// foreach($arResult["DISPLAY_PROPERTIES"]["autor"]["LINK_ELEMENT_VALUE"] as $value){
		// 	echo "Автор: " . $arResult["DISPLAY_PROPERTIES"]["autor"]["LINK_ELEMENT_VALUE"][$value["ID"]]["NAME"] . "." . "<br>";
		// }
		// foreach($arResult["DISPLAY_PROPERTIES"]["genre"]["LINK_ELEMENT_VALUE"] as $value){
		// 	echo "Жанр: " . $arResult["DISPLAY_PROPERTIES"]["genre"]["LINK_ELEMENT_VALUE"][$value["ID"]]["NAME"] . "." . "<br>";
		// }
