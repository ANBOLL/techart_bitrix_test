	...
	<form action="" method="get">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tbody><tr>
				...
				<td>
					<input class="button_search search-button" type="submit" value="<?echo GetMessage("CT_BSP_GO")?>" />
				</td>
			</tr>
		</tbody></table>
	...
	<?elseif(count($arResult["SEARCH"])>0):?>
		...
		<?foreach($arResult["SEARCH"] as $arItem):?>
			<div class="search-item">
				...
				<h4><a href="<?echo $arItem["URL_WO_PARAMS"]?>"><?echo $arItem["TITLE_FORMATED"]?></a></h4>
